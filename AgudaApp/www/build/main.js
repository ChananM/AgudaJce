...
var CalendarEventProvider = /** @class */ (function () {
    ...
    CalendarEventProvider.prototype.load = function () {
        this.posts = [
            new __WEBPACK_IMPORTED_MODULE_0__models_calendarEvent_model__["a" /* CalendarEventModel */]("", this.isoTodate("2018-04-24"), "Test1", "Let's test our calendar event"),
            new __WEBPACK_IMPORTED_MODULE_0__models_calendarEvent_model__["a" /* CalendarEventModel */]("https://s-i.huffpost.com/gen/1842880/images/n-NIGHTCLUB-628x314.jpg", this.isoTodate("2018-03-20"), "Test1", "Let's test our calendar event")
        ];
    };
...
var CalendarEventModel = /** @class */ (function () {
    function CalendarEventModel(imageURL, date, headline, content) {
        this.imageURL = imageURL;
        this.date = date;
        this.headline = headline;
        this.content = content;
